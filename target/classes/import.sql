...
insert into restaurant (id, name, freigh_rate, kitchen_id, registration_date, update_date) values (2, 'Thai Delivery', 0, 1, utc_timestamp, utc_timestamp);
insert into restaurant (id, name, freigh_rate, kitchen_id, registration_date, update_date) values (3, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp);
insert into restaurant (id, name, freigh_rate, kitchen_id, registration_date, update_date) values (4, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp);
insert into restaurant (id, name, freigh_rate, kitchen_id, registration_date, update_date) values (5, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp);
insert into restaurant (id, name, freigh_rate, kitchen_id, registration_date, update_date) values (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp);
